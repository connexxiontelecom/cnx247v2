                        ...
                        <tbody>
                            @foreach ($attendance as $attend)
                                ...
                                <tr>
                                    ...
                                    <td>{{date('d F, Y', strtotime($attend->clock_in)) ?? '-'}} <br> @ {{ date('h:i a', strtotime($attend->clock_in)) }}  <small>{{ \Carbon\Carbon::parse($attend->clock_in)->diffForHumans() ?? '-'}}</small> </td>
                                    <td>@if(!is_null($attend->clock_out)){{ date('d F, Y', strtotime($attend->clock_out))}}
																			<br> @ {{ date('h:i a', strtotime($attend->clock_out))}}  <small> | {{  \Carbon\Carbon::parse($attend->clock_out)->diffForHumans() }}</small> @else No record found. @endif</td>
